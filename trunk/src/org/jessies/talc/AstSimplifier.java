...
public class AstSimplifier implements AstVisitor<AstNode> {
    ...
    public AstNode visitBinaryOperator(AstNode.BinaryOperator binOp) {
        ...
        // A unary operator with an integer constant lhs is easy.
        // We could compute factorials here, but they get very expensive very quickly.
        // Worse, converting them to strings is slow, and makes the generated bytecode huge.
        if (op == Token.B_NOT && lhsConstant != null && lhsConstant instanceof IntegerValue) {
